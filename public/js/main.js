function changeMainSlide() {
    setInterval(function() {
        var e = $(".main-slide-navigators .btn.slide--active");
        var t = e.attr("data-slide") == $(".main-slide-navigators").children().length ? 0 : e.attr("data-slide"),
            n = $(".slider__wrapper").children('.slider__item[data-slide="'.concat(+t + 1, '"]'));
        n.siblings().hide(), n.fadeIn();
        var i = n.attr("data-bg");
        $(".bg-box").css("background-image", 'url("'.concat(i, '")')), $(".bg-box").css("opacity", 0), $(".bg-box").animate({
            opacity: 1
        }, "slow"), $('.main-slide-navigators .btn[data-slide="'.concat(+t + 1, '"]')).siblings().removeClass("slide--active"), $('.main-slide-navigators .btn[data-slide="'.concat(+t + 1, '"]')).addClass("slide--active")
    }, 3e3)
}! function(e, t) {
    "use strict";
    ...
    var f = function(n) {
        ...
        var e, f, b, r, s, h, p, v, x, l, c, k, T, a, S, g, d, y, m, C = "sizzle" + +new Date,
            w = n.document,
            $ = 0,
            i = 0,
            A = le(),
        ...
        try {
            q.apply(t = P.call(w.childNodes), w.childNodes), t[w.childNodes.length].nodeType
        } catch (e) {
            q = {
        ...
        function ae(e, t, n, i) {
            ...
            if (!i && (k(t), t = t || T, S)) {
                if (11 !== p && (l = te.exec(e)))
                    ...
                    if (d = e, u = t, 1 === p && (Y.test(e) || X.test(e))) {
                        for ((u = ne.test(e) && ve(t.parentNode) || t) === t && f.scope || ((a = t.getAttribute("id")) ? a = a.replace(oe, re) : t.setAttribute("id", a = C)), r = (c = h(e)).length; r--;) c[r] = (a ? "#" + a : ":scope") + " " + ye(c[r]);
                        d = c.join(",")
                    }
                    try {
        ...
        for (e in f = ae.support = {}, s = ae.isXML = function(e) {
                ...
                return i != T && 9 === i.nodeType && i.documentElement && (a = (T = i).documentElement, S = !s(T), w != T && (n = T.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", o, !1) : n.attachEvent && n.attachEvent("onunload", o)), f.scope = de(function(e) {
                    ...
                    var t;
                    a.appendChild(e).innerHTML = "<a id='" + C + "'></a><select id='" + C + "-\r\\' msallowcapture=''><option selected=''></option></select>", e.querySelectorAll("[msallowcapture^='']").length && g.push("[*^$]=" + I + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || g.push("\\[" + I + "*(?:value|" + _ + ")"), e.querySelectorAll("[id~=" + C + "-]").length || g.push("~="), (t = T.createElement("input")).setAttribute("name", ""), e.appendChild(t), e.querySelectorAll("[name='']").length || g.push("\\[" + I + "*name" + I + "*=" + I + "*(?:''|\"\")"), e.querySelectorAll(":checked").length || g.push(":checked"), e.querySelectorAll("a#" + C + "+*").length || g.push(".#.+[+~]"), e.querySelectorAll("\\\f"), g.push("[\\r\\n\\f]")
                }), de(function(e) {
                ...
                if (k(e), f.matchesSelector && S && !j[t + " "] && (!d || !d.test(t)) && (!g || !g.test(t))) try {
                    var n = y.call(e, t);
                    ...
                    if ((t = b.filter[e[a].type].apply(null, e[a].matches))[C]) {
                        ...
                        return function e(f, h, v, g, y, t) {
                            return g && !g[C] && (g = e(g)), y && !y[C] && (y = e(y, t)), ce(function(e, t, n, i) {
                                ...
                                } else p = be(p === t ? p.splice(c, p.length) : p), y ? y(null, t, p, i) : q.apply(t, p)
                            })
                        }(1 < a && we(d), 1 < a && ye(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(B, "$1"), t, a < n && xe(e.slice(a, n)), n < i && xe(e = e.slice(n)), n < i && ye(e))
                    }
                    d.push(t)
                } return we(d)
        }
        return ge.prototype = b.filters = b.pseudos, b.setFilters = new ge, h = ae.tokenize = function(e, t) {
            ...
            var n, g, y, m, w, i, o = [],
                ...
                s = D[e + " "];
            if (!s) {
                for (n = (t = t || h(e)).length; n--;)(s = xe(t[n]))[C] ? o.push(s) : r.push(s);
                (s = D(e, (g = r, m = 0 < (y = o).length, w = 0 < g.length, i = function(e, t, n, i, o) {
                    var r, s, a, l = 0,
                        c = "0",
                        d = e && [],
                        u = [],
                    ...
                    if (l += c, m && c !== l) {
                        ...
                        q.apply(i, u), o && !e && 0 < u.length && 1 < l + y.length && ae.uniqueSort(i)
                    }
                    return o && ($ = h, x = p), d
                }, m ? ce(i) : i))).selector = e
            }
    ...
    C.fn.extend({
        ...
        C.fn[i] = function(e, t) {
            ...
            return "Until" !== i.slice(-5) && (t = e), t && "string" == typeof t && (n = C.filter(t, n)), 1 < this.length && (H[i] || C.uniqueSort(n), N.test(i) && n.reverse()), this.pushStack(n)
        }
    });
    var q = /[^\x20\t\r\n\f]+/g;
    ...
    C.Callbacks = function(i) {
                ...
                s = {
                    ...
                    then: function(t, n, i) {
                            ...
                            return function() {
                                function e() {
                                    ...
                                    if (!(o < l)) {
                                        ...
                                        t = e && ("object" == typeof e || "function" == typeof e) && e.then, w(t) ? a ? t.call(e, c(l, r, P, a), c(l, r, M, a)) : (l++, t.call(e, c(l, r, P, a), c(l, r, M, a), c(l, r, P, r.notifyWith))) : (s !== P && (n = void 0, i = [e]), (a || r.resolveWith)(n, i))
                                    }
                                }
                                var n = this,
                                    i = arguments,
                        ...
                        return C.Deferred(function(e) {
                            r[0][3].add(c(0, e, w(i) ? i : P, e.notifyWith)), r[1][3].add(c(0, e, w(t) ? t : P)), r[2][3].add(c(0, e, w(n) ? n : M))
                        }).promise()
                    },
                    promise: function(e) {
        ...
        when: function(e) {
            ...
            var n = arguments.length,
                ...
                r = a.call(arguments),
                s = C.Deferred();
            if (n <= 1 && (_(e, s.done(t(i)).resolve, s.reject, !n), "pending" === s.state() || w(r[i] && r[i].then))) return s.then();
            for (; i--;) _(r[i], t(i), s.reject);
            return s.promise()
        }
    });
    ...
    }), C.ready.then = z.then, "complete" === S.readyState || "loading" !== S.readyState && !S.documentElement.doScroll ? T.setTimeout(C.ready) : (S.addEventListener("DOMContentLoaded", R), T.addEventListener("load", R));
    ...
    function ce(e, t) {
        for (var n, i, o, r, s, a, l = [], c = 0, d = e.length; c < d; c++)(i = e[c]).style && (n = i.style.display, t ? ("none" === n && (l[c] = G.get(i, "display") || null, l[c] || (i.style.display = "")), "" === i.style.display && se(i) && (l[c] = (a = r = o = void 0, r = i.ownerDocument, s = i.nodeName, (a = le[s]) || (o = r.body.appendChild(r.createElement(s)), a = C.css(o, "display"), o.parentNode.removeChild(o), "none" === a && (a = "block"), le[s] = a)))) : "none" !== n && (l[c] = "none", G.set(i, "display", n)));
    ...
    function we(e, t, n, i, o) {
        for (var r, s, a, l, c, d, u = t.createDocumentFragment(), p = [], f = 0, h = e.length; f < h; f++)
            ...
            for (s = s || u.appendChild(t.createElement("div")), a = (pe.exec(r) || ["", ""])[1].toLowerCase(), l = ve[a] || ve._default, s.innerHTML = l[1] + C.htmlPrefilter(r) + l[2], d = l[0]; d--;) s = s.lastChild;
            C.merge(p, s.childNodes), (s = u.firstChild).textContent = ""
        } else p.push(t.createTextNode(r));
        for (u.textContent = "", f = 0; r = p[f++];)
            if (i && -1 < C.inArray(r, i)) o && o.push(r);
            else if (c = oe(r), s = ge(u.appendChild(r), "script"), c && ye(s), n)
        ...
        r ? (G.set(e, o, !1), C.event.add(e, o, {
            ...
            handler: function(e) {
                ...
                if (1 & e.isTrigger && this[o]) {
                    ...
                    else if (i = a.call(arguments), G.set(this, o, i), t = r(this, o), this[o](), i !== (n = G.get(this, o)) || t ? G.set(this, o, !1) : n = {}, i !== n) return e.stopImmediatePropagation(), e.preventDefault(), n.value
    ...
    C.event = {
        ...
        add: function(t, e, n, i, o) {
            ...
            if (Y(t))
                for (n.handler && (n = (r = n).handler, o = r.selector), o && C.find.matchesSelector(ie, o), n.guid || (n.guid = C.guid++), (l = g.events) || (l = g.events = Object.create(null)), (s = g.handle) || (s = g.handle = function(e) {
                        return void 0 !== C && C.event.triggered !== e.type ? C.event.dispatch.apply(t, arguments) : void 0
                    }), c = (e = (e || "").match(q) || [""]).length; c--;) f = v = (a = ke.exec(e[c]) || [])[1], h = (a[2] || "").split(".").sort(), f && (u = C.event.special[f] || {}, f = (o ? u.delegateType : u.bindType) || f, u = C.event.special[f] || {}, d = C.extend({
                    type: f,
                    origType: v,
                    data: i,
                    handler: n,
    ...
    function qe(n, i, o, r) {
        ...
        var e, t, s, a, l, c, d = 0,
            ...
            f = i[0],
            h = w(f);
        if (h || 1 < u && "string" == typeof f && !m.checkClone && De.test(f)) return n.each(function(e) {
            var t = n.eq(e);
            h && (i[0] = f.call(this, e, t.html())), qe(t, i, o, r)
        });
        if (u && (t = (e = we(i, n[0].ownerDocument, !1, n, r)).firstChild, 1 === e.childNodes.length && (e = t), t || r)) {
            for (a = (s = C.map(ge(e, "script"), Ne)).length; d < u; d++) l = e, d !== p && (l = C.clone(l, !0, !0), a && C.merge(s, ge(l, "script"))), o.call(n[d], l, d);
            if (a)
                for (c = s[s.length - 1].ownerDocument, C.map(s, He), d = 0; d < a; d++) l = s[d], fe.test(l.type || "") && !G.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {
    ...
    function Pe(e, t, n) {
        for (var i, o = t ? C.filter(t, e) : e, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || C.cleanData(ge(i)), i.parentNode && (n && oe(i) && ye(ge(i, "script")), i.parentNode.removeChild(i));
        return e
    }
    C.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(m.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e)))
                for (s = ge(d), i = 0, o = (r = ge(e)).length; i < o; i++) a = r[i], "input" === (c = (l = s[i]).nodeName.toLowerCase()) && ue.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (t)
                if (n)
                    for (r = r || ge(e), s = s || ge(d), i = 0, o = r.length; i < o; i++) Oe(r[i], s[i]);
                else Oe(e, d);
    ...
    var _e, Ie, ze, Re, We, Fe, Be, Ue, Xe = new RegExp("^(" + ee + ")(?!px)[a-z%]+$", "i"),
        Ye = function(e) {
    ...
    function Ge(e, t, n) {
        ...
        return (n = n || Ye(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || oe(e) || (s = C.style(e, t)), !m.pixelBoxStyles() && Xe.test(s) && Ve.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
    }
    ...
    function Je() {
        var e;
        Ue && (Be.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", Ue.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", ie.appendChild(Be).appendChild(Ue), e = T.getComputedStyle(Ue), _e = "1%" !== e.top, Fe = 12 === Ke(e.marginLeft), Ue.style.right = "60%", Re = 36 === Ke(e.right), Ie = 36 === Ke(e.width), Ue.style.position = "absolute", ze = 12 === Ke(Ue.offsetWidth / 3), ie.removeChild(Be), Ue = null)
    }

    function Ke(e) {
        return Math.round(parseFloat(e))
    }
    Be = S.createElement("div"), (Ue = S.createElement("div")).style && (Ue.style.backgroundClip = "content-box", Ue.cloneNode(!0).style.backgroundClip = "", m.clearCloneStyle = "content-box" === Ue.style.backgroundClip, C.extend(m, {
        ...
        reliableTrDimensions: function() {
            var e, t, n, i;
            return null == We && (e = S.createElement("table"), t = S.createElement("tr"), n = S.createElement("div"), e.style.cssText = "position:absolute;left:-11111px", t.style.height = "1px", n.style.height = "9px", ie.appendChild(e).appendChild(t).appendChild(n), i = T.getComputedStyle(t), We = 3 < parseInt(i.height), ie.removeChild(e)), We
        }
    }));
        ...
        css: function(e, t) {
            return W(this, function(e, t, n) {
                var i, o, r = {},
                    s = 0;
                if (Array.isArray(t)) {
                    for (i = Ye(e), o = t.length; s < o; s++) r[t[s]] = C.css(e, t[s], !1, i);
                    return r
                }
    ...
    C.Animation = C.extend(xt, {
        ...
        tweener: function(e, t) {
            for (var n, i = 0, o = (e = w(e) ? (t = e, ["*"]) : e.match(q)).length; i < o; i++) n = e[i], xt.tweeners[n] = xt.tweeners[n] || [], xt.tweeners[n].unshift(t)
        },
        prefilters: [function(e, t, n) {
            ...
            for (i in n.queue || (null == (s = C._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function() {
                ...
                for (i in u && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = g && g.display) && (c = G.get(e, "display")), "none" === (d = C.css(e, "display")) && (c ? d = c : (ce([e], !0), c = e.style.display || c, d = C.css(e, "display"), ce([e]))), ("inline" === d || "inline-block" === d && null != c) && "none" === C.css(e, "float") && (l || (p.done(function() {
                        h.display = c
    ...
    C.extend(C.event, {
        trigger: function(e, t, n, i) {
            var o, r, s, a, l, c, d, u = [n || S],
                ...
                h = d = r = n = n || S;
            if (3 !== n.nodeType && 8 !== n.nodeType && !Lt.test(p + C.event.triggered) && (-1 < p.indexOf(".") && (p = (f = p.split(".")).shift(), f.sort()), a = p.indexOf(":") < 0 && "on" + p, (e = e[C.expando] ? e : new C.Event(p, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = f.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : C.makeArray(t, [e]), c = C.event.special[p] || {}, i || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                if (!i && !c.noBubble && !v(n)) {
                    for (s = c.delegateType || p, Lt.test(s + p) || (h = h.parentNode); h; h = h.parentNode) u.push(h), r = h;
                    r === (n.ownerDocument || S) && u.push(r.defaultView || r.parentWindow || T)
                }
                for (o = 0;
                    (h = u[o++]) && !e.isPropagationStopped();) d = h, e.type = 1 < o ? s : c.bindType || p, (l = (G.get(h, "events") || Object.create(null))[e.type] && G.get(h, "handle")) && l.apply(h, t), (l = a && h[a]) && l.apply && Y(h) && (e.result = l.apply(h, t), !1 === e.result && e.preventDefault());
                return e.type = p, i || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(u.pop(), t) || !Y(n) || a && w(n[p]) && !v(n) && ((r = n[a]) && (n[a] = null), C.event.triggered = p, e.isPropagationStopped() && d.addEventListener(p, jt), n[p](), e.isPropagationStopped() && d.removeEventListener(p, jt), C.event.triggered = void 0, r && (n[a] = r)), e.result
            }
        },
    ...
    C.param = function(e, t) {
        ...
        if (Array.isArray(e) || e.jquery && !C.isPlainObject(e)) C.each(e, function() {
            ...
            for (i in e) ! function n(i, e, o, r) {
                ...
                if (Array.isArray(e)) C.each(e, function(e, t) {
                    o || qt.test(i) ? r(i, t) : n(i + "[" + ("object" == typeof t && null != t ? e : "") + "]", t, o, r)
                });
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !C(this).is(":disabled") && _t.test(this.nodeName) && !Mt.test(e) && (this.checked || !ue.test(e))
            }).map(function(e, t) {
                var n = C(this).val();
    ...
    Vt.href = Nt.href, C.extend({
        ...
        ajax: function(e, t) {
            ...
            if (w.promise(k), g.url = ((e || g.url || Nt.href) + "").replace(Bt, Nt.protocol + "//"), g.type = t.method || t.type || g.method || g.type, g.dataTypes = (g.dataType || "*").toLowerCase().match(q) || [""], null == g.crossDomain) {
                i = S.createElement("a");
                try {
            ...
            if (g.data && g.processData && "string" != typeof g.data && (g.data = C.param(g.data, g.traditional)), Qt(Ut, g, t, k), h) return k;
            for (o in (v = C.event && g.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), g.type = g.type.toUpperCase(), g.hasContent = !Ft.test(g.type), u = g.url.replace(zt, ""), g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(It, "+")) : (r = g.url.slice(u.length), g.data && (g.processData || "string" == typeof g.data) && (u += (Ot.test(u) ? "&" : "?") + g.data, delete g.data), !1 === g.cache && (u = u.replace(Rt, "$1"), r = (Ot.test(u) ? "&" : "?") + "_=" + Ht.guid++ + r), g.url = u + r), g.ifModified && (C.lastModified[u] && k.setRequestHeader("If-Modified-Since", C.lastModified[u]), C.etag[u] && k.setRequestHeader("If-None-Match", C.etag[u])), (g.data && g.hasContent && !1 !== g.contentType || t.contentType) && k.setRequestHeader("Content-Type", g.contentType), k.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + Yt + "; q=0.01" : "") : g.accepts["*"]), g.headers) k.setRequestHeader(o, g.headers[o]);
            if (g.beforeSend && (!1 === g.beforeSend.call(y, k, g) || h)) return k.abort();
            if (l = "abort", b.add(g.complete), k.done(g.success), k.fail(g.error), d = Qt(Xt, g, t, k)) {
    ...
    m.cors = !!Zt && "withCredentials" in Zt, m.ajax = Zt = !!Zt, C.ajaxTransport(function(o) {
        ...
        if (m.cors || Zt && !o.crossDomain) return {
            send: function(e, t) {
                ...
                r = function(e) {
                    return function() {
                        r && (r = s = i.onload = i.onerror = i.onabort = i.ontimeout = i.onreadystatechange = null, "abort" === e ? i.abort() : "error" === e ? "number" != typeof i.status ? t(0, "error") : t(i.status, i.statusText) : t(Kt[i.status] || i.status, i.statusText, "text" !== (i.responseType || "text") || "string" != typeof i.responseText ? {
                            binary: i.response
                        } : {
                            text: i.responseText
    ...
    C.ajaxSetup({
        ...
        var i, o, r, s = !1 !== e.jsonp && (nn.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && nn.test(e.data) && "data");
        if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = w(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(nn, "$1" + i) : !1 !== e.jsonp && (e.url += (Ot.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function() {
        ...
        var i, o, r, s = this,
            a = e.indexOf(" ");
        return -1 < a && (i = $t(e.slice(a)), e = e.slice(0, a)), w(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), 0 < s.length && C.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
        ...
        C.cssHooks[n] = Qe(m.pixelPosition, function(e, t) {
            if (t) return t = Ge(e, n), Xe.test(t) ? C(e).position()[n] + "px" : t
        })
    }), C.each({
        Height: "height",
        Width: "width"
    ...
    }), C.each("blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu".split(" "), function(_e, n) {
        C.fn[n] = function(e, t) {
    ...
    }, C.isArray = Array.isArray, C.parseJSON = JSON.parse, C.nodeName = A, C.isFunction = w, C.isWindow = v, C.camelCase = X, C.type = x, C.now = Date.now, C.isNumeric = function(e) {
        var t = C.type(e);
...
function(e) {
    ...
    o = 0, (s = function(e, t) {
        ...
        var e, t = this,
            n = t.touchObject.startX - t.touchObject.curX,
            i = t.touchObject.startY - t.touchObject.curY,
            o = Math.atan2(i, n);
        return (e = Math.round(180 * o / Math.PI)) < 0 && (e = 360 - Math.abs(e)), e <= 45 && 0 <= e || e <= 360 && 315 <= e ? !1 === t.options.rtl ? "left" : "right" : 135 <= e && e <= 225 ? !1 === t.options.rtl ? "right" : "left" : !0 === t.options.verticalSwiping ? 35 <= e && e <= 135 ? "down" : "up" : "vertical"
    ...
    fetch("https://api.openweathermap.org/data/2.5/weather?q=Fergana&appid=0e695f70b4fc658773b511d44b35cc79").then(function(e) {
        return e.json()
    }).then(function(e) {
        $("#temp").html(Math.round(e.main.temp - 273) + "   &degC"), $(".temp").html(Math.round(e.main.temp - 273) + "   &degC"), $("#img").html('<img src="https://openweathermap.org/img/w/'.concat(e.weather[0].icon, '.png" alt="">')), $(".img").html('<img src="https://openweathermap.org/img/w/'.concat(e.weather[0].icon, '.png" alt="">'))
    });
    $(".getReys").click(function(e) {
        e.preventDefault(), $(this).addClass("tablo__active2"), $(this).siblings().removeClass("tablo__active2");
        var t = $(this).data("key");
        $.ajax({
            headers: {
        ...
        e.preventDefault(), $(this).addClass("news__link--active"), $(this).siblings().removeClass("news__link--active"), $("#tender").css("display", "block"), $("#info").css("display", "none"), $("#news").css("display", "none")
    }), $(".getNews").click(function(e) {
        e.preventDefault(), $(this).addClass("news__link--active"), $(this).siblings().removeClass("news__link--active"), $("#news").css("display", "block"), $("#info").css("display", "none"), $("#tender").css("display", "none")
    }), $(".getInfo").click(function(e) {
        e.preventDefault(), $(this).addClass("news__link--active"), $(this).siblings().removeClass("news__link--active"), $("#info").css("display", "block"), $("#news").css("display", "none"), $("#tender").css("display", "none")
    }),  $(".main-slide-navigators li").click(function() {
        var e = $(this).attr("data-slide"),
            t = $(".slider__wrapper").children('.slider__item[data-slide="'.concat(e, '"]'));
        console.log(t), t.siblings().hide(), t.fadeIn();
        var n = t.attr("data-bg");
        console.log(n), $(".bg-box").css("background-image", 'url("'.concat(n, '")')), $(".bg-box").css("opacity", 0), $(".bg-box").animate({
            opacity: 1
        }, "slow"), $(this).siblings().removeClass("slide--active"), $(this).addClass("slide--active")
    })
}), $(document).ready(function() {
    try {
    ...
    ok = !0, $(".search__img").click(function() {
        ok = 1 == ok ? ($(".form__none").css("transform", "translateX(-95%) scaleY(1)"), !1) : ($(".form__none").css("transform", "translateX(-95%) scaleY(0)"), !0)
    }), $(".topmenu__item").mouseout(function() {
        $(this).children(".absolute__ul").slideToggle()
    }), $(".faq__head").click(function() {
        $(this).siblings(".faq__main").is(":visible") ? ($(".plus-img").removeClass("i__active"), $(this).siblings(".faq__main").hide("slow")) : ($(".faq__head").siblings(".faq__main").hide("slow"), $(".plus-img").removeClass("i__active"), $(this).siblings(".faq__main").show("slow"), $(this).children(".plus-img").addClass("i__active"))
    }), $(".lang_btn").click(function() {
        $(this).parent().toggleClass("dropdown--open")
    }), $(".footer__otziv").click(function() {
        $(".modal-otziv").addClass("form-modal--active"), $("body").css("overflow-y", "hidden")
    }), $('.close[data-dismiss="modal"]').click(function() {
        $(".form-modal").removeClass("form-modal--active"), $("body").css("overflow-y", "auto")
    }), $(".navbar-btn").click(function() {
        $(".menu-mask").addClass("menu-mask--active"), $(".topmenu").addClass("topmenu--active"), $("body").css("overflow-y", "hidden")
    }), $(".menu-mask").click(function() {
        $(".menu-mask").removeClass("menu-mask--active"), $(".topmenu").removeClass("topmenu--active"), $("body").css("overflow-y", "auto")
    }), $(".close-menu-btn").click(function() {
        $(".menu-mask").removeClass("menu-mask--active"), $(".topmenu").removeClass("topmenu--active"), $("body").css("overflow-y", "auto")
    }), $(".topmenu__link").click(function() {
        console.log("ok"), $(this).next().toggle()
    })
});